...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/images/bar transparent.png", "assets/images/bar transparent.png");
			type.set ("assets/images/bar transparent.png", Reflect.field (AssetType, "image".toUpperCase ()));

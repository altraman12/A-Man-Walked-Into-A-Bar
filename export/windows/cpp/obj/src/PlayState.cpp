...
bool PlayState_obj::justPressed( ){
	HX_STACK_FRAME("PlayState","justPressed",0xfbf55b45,"PlayState.justPressed","PlayState.hx",53,0xb30d7781)
	HX_STACK_THIS(this)
	HX_STACK_LINE(53)
...
bool PlayState_obj::pressed( ){
	HX_STACK_FRAME("PlayState","pressed",0x8427fc91,"PlayState.pressed","PlayState.hx",67,0xb30d7781)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
...
bool PlayState_obj::justReleased( ){
	HX_STACK_FRAME("PlayState","justReleased",0x81908eba,"PlayState.justReleased","PlayState.hx",81,0xb30d7781)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	::flixel::input::mouse::FlxMouseButton _this = ::flixel::FlxG_obj::mouse->_leftButton;		HX_STACK_VAR(_this,"_this");
	HX_STACK_LINE(81)
...
::flixel::util::FlxPoint PlayState_obj::clickCoords( ){
	HX_STACK_FRAME("PlayState","clickCoords",0x00d447f5,"PlayState.clickCoords","PlayState.hx",100,0xb30d7781)
	HX_STACK_THIS(this)
	HX_STACK_LINE(100)
...
{
		HX_STACK_FRAME("PlayState","run",0xf8c2adba,"PlayState.run","PlayState.hx",159,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(159)
		if ((!(this->dead))){
			HX_STACK_LINE(161)
...
{
		HX_STACK_FRAME("PlayState","runTime",0x247b0ae7,"PlayState.runTime","PlayState.hx",167,0xb30d7781)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("PlayState","runTween",0xd0696a51,"PlayState.runTween","PlayState.hx",172,0xb30d7781)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("PlayState","jump",0xac4b9f9f,"PlayState.jump","PlayState.hx",177,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(178)
		...
		struct _Function_1_1{
			inline static Dynamic Block( Float &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","PlayState.hx",179,0xb30d7781)
				{
...
{
		HX_STACK_FRAME("PlayState","fall",0xa997972c,"PlayState.fall","PlayState.hx",184,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Tween,"Tween")
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","PlayState.hx",184,0xb30d7781)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_CSTRING("x") , (Float(::flixel::FlxG_obj::width) / Float((int)5)),false);
...
{
		HX_STACK_FRAME("PlayState","slide",0x3e854560,"PlayState.slide","PlayState.hx",188,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(189)
...
{
		HX_STACK_FRAME("PlayState","update",0x8d182efa,"PlayState.update","PlayState.hx",204,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(205)
		this->super::update();
		HX_STACK_LINE(207)
		if (((this->player->x >= this->alcoholBar->x))){
			HX_STACK_LINE(209)
			::flixel::FlxState State = ::CutScene1_obj::__new(null());		HX_STACK_VAR(State,"State");
			HX_STACK_LINE(209)
...
{
		HX_STACK_FRAME("PlayState","clickChicken",0x6e1ebd7e,"PlayState.clickChicken","PlayState.hx",256,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(256)
		::flixel::FlxState State = ::CutScene1_obj::__new(null());		HX_STACK_VAR(State,"State");
		HX_STACK_LINE(256)
...
{
		HX_STACK_FRAME("PlayState","clickMenu",0x63ab75b6,"PlayState.clickMenu","PlayState.hx",261,0xb30d7781)
		HX_STACK_THIS(this)
		HX_STACK_LINE(261)

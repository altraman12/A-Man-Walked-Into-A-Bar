...
::ChickenState_obj::__boot();
::CutScene1_obj::__boot();
::CutScene2_obj::__boot();
::CutScene3_obj::__boot();
::CutScene3Lose_obj::__boot();
::Date_obj::__boot();
::openfl::_v2::AssetLibrary_obj::__boot();
::DefaultAssetLibrary_obj::__boot();
::Door_obj::__boot();
::GhostState_obj::__boot();
::Lambda_obj::__boot();
::List_obj::__boot();
::IMap_obj::__boot();
